...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pais al cual representa un atleta");
	...
	private void ejecutarPaisAtleta()
	{
		...
		String atleta = input("Por favor ingrese el nombre del atleta que desea buscar");
		Atleta elAtleta  = calculadora.buscarAtleta2(atleta);
		
		if(elAtleta == null){
			System.out.println("No se encontro el atleta que esta buscando: " + atleta);
		}
		else if(elAtleta!= null){
			Pais pais = elAtleta.darPais();
			String elpais = pais.darNombre();
			System.out.println("El atleta " + atleta + "representa a el pais: " + elpais);
		}
	}
